...
const u16 irff00_msg_music_table[][IR_KEY_MAX_NUM] = {			//Music模式下的遥控转换表
...
const u16 iokey_msg_mbox_music_table[][IO_KEY_MAX_NUM] = {
...
const u16 adkey_msg_mbox_music_table[][AD_KEY_MAX_NUM] = {
