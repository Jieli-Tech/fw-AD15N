...
const u16 irff00_msg_usb_slave_table[][IR_KEY_MAX_NUM] = {
    /*短按*/	    {IRFF00_USB_SLAVE_SHORT},
    /*短按抬起*/	{IRFF00_USB_SLAVE_SHORT_UP},
    /*长按*/		{IRFF00_USB_SLAVE_LONG},
    /*连按*/		{IRFF00_USB_SLAVE_HOLD},
    /*长按抬起*/	{IRFF00_USB_SLAVE_LONG_UP},
#if (KEY_DOUBLE_CLICK_EN)
    /*双击*/		{IRFF00_USB_SLAVE_DOUBLE_KICK},
    /*三击*/		{IRFF00_USB_SLAVE_TRIPLE_KICK},
#endif
};
#endif
...
const u16 iokey_msg_usb_slave_table[][IO_KEY_MAX_NUM] = {
    /*短按*/		{IOKEY_USB_SLAVE_SHORT},
    /*短按抬起*/	{IOKEY_USB_SLAVE_SHORT_UP},
    /*长按*/		{IOKEY_USB_SLAVE_LONG},
    /*连按*/		{IOKEY_USB_SLAVE_HOLD},
    /*长按抬起*/	{IOKEY_USB_SLAVE_LONG_UP},
#if (KEY_DOUBLE_CLICK_EN)
    /*双击*/		{IOKEY_USB_SLAVE_DOUBLE_KICK},
    /*三击*/        {IOKEY_USB_SLAVE_TRIPLE_KICK},
#endif
};
#endif
...
const u16 adkey_msg_usb_slave_table[][AD_KEY_MAX_NUM] = {
    /*短按*/		{ADKEY_USB_SLAVE_SHORT},
    /*短按抬起*/	{ADKEY_USB_SLAVE_SHORT_UP},
    /*长按*/		{ADKEY_USB_SLAVE_LONG},
    /*连按*/		{ADKEY_USB_SLAVE_HOLD},
    /*长按抬起*/	{ADKEY_USB_SLAVE_LONG_UP},
#if (KEY_DOUBLE_CLICK_EN)
    /*双击*/		{ADKEY_USB_SLAVE_DOUBLE_KICK},
    /*双击*/		{ADKEY_USB_SLAVE_TRIPLE_KICK},
#endif
};
#endif
