...
//测试频率：32.768K
#define LOG_TAG_CONST       NORM //RDA5807
#define LOG_TAG             "[RDA5807]"
#include "log.h"
...
bool rda5807_read_id(void)
{
    ...
    if (read_dat[8] == 0x58 && read_dat[9] == 0x04) {	//FM_RDA5807SP
        ...
        log_info("rda5807_read_id fail\n");
        fm_type = 0;
        return 0;
    }

    log_info("rda5807_read_id OK fm_type = %d\n", fm_type);
    return 1;
}
...
void rda5807_test()
{
    ...
    if (rda5807_read_id()) {
        rda5807_init();
        rda5807_set_fre(951);//(951);//(915);//(875);
    }
}
#endif
#endif
