...
//测试频率：32.768K
#define LOG_TAG_CONST       NORM //BK1080
#define LOG_TAG             "[bk1080]"
#include "log.h"
...
const u16 HW_Reg[] = {
    ...
    0x0000,
    0xC040,
    0x1F0f,	  //reg5	RSSI[15:8] BAND[7:6] SPACE[5:4],Europe standar
    0x2E00,
    0xFF02,
    0x115B,
    0x0000,
...
bool bk1080_read_id(void)
{
    ...
    log_info("bk1080_read_id %x", bk_id);
    if (0x8010 == bk_id) {
        return TRUE;
    }
    return FALSE;
...
void bk1080_test()
{
    ...
    if (bk1080_read_id()) {
        bk1080_init();
        bk1080_set_fre(875);//(951);//(915);//(875);
    }
}
#endif
#endif
