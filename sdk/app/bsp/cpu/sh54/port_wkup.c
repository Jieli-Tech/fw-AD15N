...
void port_wkup_test_main()
{
    ...
    port_wkup_enable(IO_PORTA_10, 0);//PA10-IO中断，0:上升沿触发
    /* port_wkup_disable(IO_PORTA_10); */
    uartx_wkup_enable(0, IO_PORTA_05, 0); //uart0 rx PA5-IO中断，0:上升沿触发
    /* uartx_wkup_disable(0,IO_PORTA_05); */
    uartx_wkup_enable(1, IO_PORTA_09, 0); //uart1 rx PA9-IO中断，0:上升沿触发
    /* uartx_wkup_disable(1,IO_PORTA_09); */
    irflt_wkup_enable(IO_PORTA_06, 0);//PA6-IO中断，0:上升沿触发
    /* irflt_wkup_disable(IO_PORTA_06); */
