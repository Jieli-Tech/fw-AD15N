...
//=                                                                           =
//=============================================================================
u16 apa_dual_buf[DAC_PACKET_SIZE * 2] AT(.DAC_BUFFER);

void apa_mode_init(void)
{
    memset(&apa_dual_buf[0], 0, sizeof(apa_dual_buf));
    apa_resource_init((u8 *)&apa_dual_buf[0], sizeof(apa_dual_buf), APA_DEFAULT, 0);
}
...
#if (0 == (APA_DEFAULT & APA_MODE2_SNR))
