...
cd voice_toy
isd_download.exe -tonorflash -dev sh57 -boot 0x3f01000 -div8 -wait 300 -uboot uboot.boot -app app.bin 0x20000 -res dir_a dir_song dir_eng dir_poetry dir_story dir_bin_f1x dir_notice dir_midi midi_cfg
