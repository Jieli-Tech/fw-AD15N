...
#define JL_SD0_BASE                     (ls_sd0_base + map_adr(0x00, 0x00))
...
typedef struct {
    ...
    __WO __u32 EP4_TADR;
    __WO __u32 EP4_RADR;
    __RW __u32 EP1_RX_EADR;
    __RW __u32 EP2_RX_EADR;
} JL_USB_TypeDef;

#define JL_USB_BASE                     (ls_usb_base + map_adr(0x00, 0x00))
