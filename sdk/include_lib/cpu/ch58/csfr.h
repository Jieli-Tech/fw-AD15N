...
typedef struct {
    __RW __u32 CON[15]; // 0-3 used in cd09
    __RO __u32 REV0;
    __RW __u32 CID[15]; // 0-3 used in cd09
    __RO __u32 REV1;
    __RW __u32 BEG[15]; // 0-3 used in cd09
    __RO __u32 REV2;
    __RW __u32 END[15]; // 0-3 used in cd09
    __RW __u32 WREN;
} JL_MPU_TypeDef;
...
//} JL_FFT_TypeDef;
//
//#define JL_FFT_BASE                   (csfr_base + map_adr(0x06, 0x00))
