...
///no for user
void _p33_xor_1byte(u16 addr, u8 data0);
void _p33_and_1byte(u16 addr, u8 data0);
void _p33_or_1byte(u16 addr, u8 data0);
void _p33_tx_1byte(u16 addr, u8 data0);
u8 _p33_rx_1byte(u16 addr);
void _P33_CON_SET(u16 addr, u8 start, u8 len, u8 data);
 ...
 *-------------------P3_ANA_CON3
 */
#define FORCE_BYPASS_EN(en)     P33_TX_NBIT(P3_ANA_CON3, BIT(0), en)
...
#define LVCMP_DET_GET()			(((P33_CON_GET(P3_LVCMP_CON) & BIT(5)) ? 1: 0) ^ ((P33_CON_GET(P3_LVCMP_CON) & BIT(1)) ? 1: 0))
