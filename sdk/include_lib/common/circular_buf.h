...
extern u32 cbuf_lifo_write(cbuffer_t *cbuffer, void *buf, u32 len);
...
#define cbuf_get_data_size(a) ((cbuffer_t *)(a))->data_len

#define cbuf_get_readptr(a ) (a)->read_ptr

#define cbuf_get_space(a) ((cbuffer_t *)a)->total_len

#define _cbuf_get_available_space(a)	((a)->total_len - (a)->data_len)
